...
| `cd frontend && npm test` | Pass | 6 Playwright tests passed after adding guided workflow/recovery UX coverage. |
...
| `python scripts/stress_large_package.py` | Pass | 24 sheets, 24 findings imported/exported, validation passed in 2.4s, and wrote `data/validation_reports/autoqc_large_package_stress.md`. |
| `python scripts/regression_real_pdfs.py` | Pass | Ran against `20250508_Alliant Sheboygan Skid Upgrade_IFC.pdf`: 123 pages, draft validation passed, final validation passed, 67.1s, and wrote `data/validation_reports/autoqc_real_pdf_regression.md`. |
