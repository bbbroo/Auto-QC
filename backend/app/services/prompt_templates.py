...
BASE_EXHAUSTIVE_PRIORITIES = [
    ...
    "Xcel Engineering Package QC checklist coverage where applicable and visibly supported: All Sheets, Cover Sheet, Index, General Notes, Regulator Characteristics, PFD, P&ID, Civil/Structural, Civil Site, Demo, Mechanical Plan, Piping Sections/Details, Isometric, Heat Number/MTR, Weld/NDE, Bolt Torque, BOM, and Environmental sheets.",
...
DEFAULT_PROMPT_TEMPLATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "when_not_to_use": "Do not use for broader process, civil, mechanical, regulator station, or package checklist review.",
        "review_priorities": [
    ...
    },
    {
        ...
        "version": EXHAUSTIVE_PROMPT_VERSION,
        "description": "Full manual-style package review with Xcel Engineering Package QC Checklist R0 2026-06-15 coverage where applicable and visibly supported.",
        "category": "Client-specific",
        "intended_use": "Xcel-style engineering package QC using applicable checklist concepts as review guidance while still reviewing every visible sheet.",
        "review_depth": EXHAUSTIVE_REVIEW_DEPTH,
        "when_to_use": "Use for Xcel packages or packages intentionally following the Xcel checklist structure when exhaustive manual review is required.",
    ...
    },
    {
        ...
        "version": EXHAUSTIVE_PROMPT_VERSION,
        "description": "Exhaustive manual-style review combining AutoQC coordination, regulator-station, title block/revision, drafting-quality, civil/site/environmental/permitting, mechanical/demo/detail, fabrication/traceability, and applicable Xcel checklist coverage.",
        "category": "General",
